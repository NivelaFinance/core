...
/**
 * @title Floor
 * @dev Price floor mechanism for NIV token
 * @notice Manages nUSD deposits and refunds for stability
 */
contract Floor is Ownable, ReentrancyGuard, IFloor {
    ...
    /**
     * @notice Deposits nUSD to increase floor capital
    ...
    /**
     * @notice Refunds nUSD by burning NIV
     * @param msgSender User address
     * @param burnAmount Amount of NIV to burn
     */
    function refund(
        address msgSender,
        uint256 burnAmount
