    ...
    IVoteEscrowedNIV
{
    /*//////////////////////////////////////////////////////////////
                        TOKEN CONFIGURATION
    //////////////////////////////////////////////////////////////*/
    /// @notice Base NIV token contract
    ...
    //////////////////////////////////////////////////////////////*/
    /// @notice Total supply of veNIV tokens
    ...
    //////////////////////////////////////////////////////////////*/
    /**
     * @notice Initializes the veNIV token
     * @param name_ Token name
     * @param symbol_ Token symbol
     * @param baseContracts_ BaseContracts instance for protocol integration
     *
     * Requirements:
     * · NIV contract address must be non-zero
     *
     * Effects:
     * · Sets token metadata
     * · Sets base NIV token reference
     */
    constructor(
        string memory name_,
    ...
    function withdraw() external nonReentrant {
        ...
        _totalSupply -= amount;
        niv.rebase();
        SafeERC20.safeTransfer(IERC20(address(niv)), account, amount);
