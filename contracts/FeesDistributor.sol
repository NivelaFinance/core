 ...
 * @dev Manages fee distribution system between floor and staked nUSD holders
 * @notice Facilitates:
 * · Fee collection and distribution
 * · Floor and stnUSD rewards
 */
contract FeesDistributor is Ownable, IFeesDistributor {
    ...
    /// @notice Staked nUSD contract for rewards
    /// @dev Immutable for gas optimization
    ...
    uint256 public constant MIN_DISTRIBUTION_BALANCE = 10e18; // 10 nUSD
    /*//////////////////////////////////////////////////////////////
                                EVENTS
    //////////////////////////////////////////////////////////////*/
    ...
    constructor(IBaseContracts baseContracts_) {
        ...
        bool approveStakednUSD = nusd.approve(
            address(stnUSD),
            type(uint256).max
        );
        if (!approveStakednUSD) revert ApproveFailed();
        bool approveFloor = nusd.approve(address(floor), type(uint256).max);
    ...
    //////////////////////////////////////////////////////////////*/
    /**
     * @notice Executes fee distribution to floor and stnUSD
     * @dev Process:
     * 1. Check staked supply
     * 2. Check available balance
     * 3. Calculate floor portion
     * 4. Distribute to floor
     * 5. Distribute remaining to stnUSD
     *
     * Security:
    ...
    function distribute() external onlyOwner {
        uint256 stakedSupply = IERC20Token(address(stnUSD)).totalSupply();
        ...
        stnUSD.distributeFees(balance - floorDistribution);
    }
