...
contract LiquidationHelper is Ownable, ReentrancyGuard {
    ...
    //////////////////////////////////////////////////////////////*/
    /**
     * @notice Initializes the helper with nUSD token
     ...
     * @return requirednUSDAmount nUSD needed for liquidation
     * @dev Process:
     ...
     * @return adjustedBorrowPart Final borrow part
     * @return requirednUSDAmount nUSD needed
     * @dev Process:
     * 1. Validate amount
    ...
    {
        (collateralAmount, adjustedBorrowPart, requirednUSDAmount) = LenderLib
