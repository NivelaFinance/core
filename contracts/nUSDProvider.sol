...
/**
 * @title nUSDProvider
 * @dev Manages nUSD token provision and distribution for lending markets
 * @notice Facilitates:
 * · nUSD token minting and provision
 * · Vault deposits for lending markets
 * · Token approval management
 */
contract nUSDProvider is Context, InUSDProvider {
    /*//////////////////////////////////////////////////////////////
                                STORAGE
    //////////////////////////////////////////////////////////////*/
    ...
    /*//////////////////////////////////////////////////////////////
                                EVENTS
    //////////////////////////////////////////////////////////////*/
    /// @notice Emitted when nUSD tokens are provided to a lending market
    /// @param lender Address of the lending market receiving tokens
    /// @param amount Quantity of nUSD tokens provided
    event nUSDProvided(address indexed lender, uint256 amount);
    /*//////////////////////////////////////////////////////////////
                            CUSTOM ERRORS
    //////////////////////////////////////////////////////////////*/
    ...
    constructor(IBaseContracts baseContracts_) {
        ...
        address nusdAddr = address(baseContracts.nusd());
        _ensureNonzeroAddress(nusdAddr);
        nusd = IERC20Token(nusdAddr);
    ...
    //////////////////////////////////////////////////////////////*/
    /**
     * @notice Provides nUSD tokens to a lending market
     * @param amount Quantity of nUSD tokens to provide
     * @dev Process flow:
