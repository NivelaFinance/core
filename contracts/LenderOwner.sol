...
contract LenderOwner is Ownable, ILenderOwner {
    ...
    //////////////////////////////////////////////////////////////*/
    /**
     * @notice Rescues nUSD tokens to treasury
     * @dev Process:
     * 1. Check balance
     ...
     * · Safe transfer
     */
    function rescuenUSD() external onlyOwner {
    ...
    function changeInterestRate(
        ...
        // Check if lender's collateral is veNIV
        if (address(lender.collateral()) == address(baseContracts.veNIV())) {
            // Apply different interest rate for veNIV collateral
